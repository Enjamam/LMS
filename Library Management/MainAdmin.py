...
from AddLibrarian import *
from DeleteLibrarian import *
# from DeleteLibrarian import *
...
def Main_Admin():
    ...
    def addlibr(): # Not used
         root.destroy()
         addlibri()

    def deletelibrn(): # Not used
         root.destroy()
         deleteLibr()
    ...
    btn1 = Button(root,text="Add Librarian",bg='teal', fg='white', font=('Georgia Bold', 18), bd=10, command=addlibri)
    btn1.place(relx=0.28,rely=0.45, relwidth=0.45,relheight=0.15)
        
    btn2 = Button(root,text="Delete Librarian",bg='teal', fg='white', font=('Georgia Bold', 18), bd=10, command=deleteLibr)
